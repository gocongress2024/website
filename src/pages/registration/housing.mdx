...
- Available rooms: 110
- Room Rate: Broadway Hall $76/night, Ondine Hall $63/night (No Tax)
- Linen Pack: $54 one time fee with no exchanges, add $12 per night for 2 exchanges per week.
(Linen pack includes flat sheet, fitted sheet, pillow w/case, blanket, body towel, hand towel, bath mat, washcloth.)


### PSU also offers an on campus hotel which is less expensive then the other hotel options, and includes breakfast.
...
### We have reserved blocks of rooms at discounted rates at the following hotels:
1. **Hotel Vance**
 - [Book Here](https://www.marriott.com/events/start.mi?id=1700520591527&key=GRP) This block goes from the 11th - 23rd, so make sure you adjust the days if you're not staying that long. (Congress is from the 13th - 21st)
...
2. **Hotel Zags**
 - [Book Here](https://www.thehotelzags.com/) NEED TO FILL IN ONCE THEY SEND LINK
 - You can also call to book, our event name is: American Go Conference
